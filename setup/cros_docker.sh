...
RESOURCE_UFTP_SHA1="56dcdf98b587b1979aae0bda6130039e6a09fb9e"
...
DOCKER_IMAGE_GITHASH="92558d6d249f0bd9dd30e2628cf9a7b790989ccd"
DOCKER_IMAGE_TIMESTAMP="20210307204429"
...
do_umpire_run() {
  ...
  ${DOCKER} run \
    ...
    --env "UMPIRE_PROJECT_PORT=${UMPIRE_PORT}" \
    --privileged \
    "${DOCKER_IMAGE_NAME}" \
