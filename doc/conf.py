...
latex_documents = [
    ('index', 'factory.tex', u'CrOS Factory Documentation',
     u'CrOS Factory', 'manual'),
]
...
man_pages = [
    ('index', 'factory', u'CrOS Factory Documentation',
     [u'CrOS Factory'], 1)
]
...
texinfo_documents = [
    ('index', 'factory', u'CrOS Factory Documentation',
     u'CrOS Factory', 'factory', 'One line description of project.',
     'Miscellaneous'),
]
