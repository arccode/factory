...
ARCHIVER_CLI = 'py/lumberjack/archiver_cli.py'
REGCODE_DEFAULT_KEY = ('py/lumberjack/google-crosreg-key.bin.public')
...
class ArchiverService(umpire_service.UmpireService):
  ...
  def GenerateConfig(umpire_config, env):
    ...
    toolkit_dir = env.server_toolkit_dir
  ...
  def CreateProcesses(self, config, env):
    ...
    proc_config = {
        'executable': os.path.join(env.server_toolkit_dir, ARCHIVER_CLI),
        'name': ARCHIVER_NAME,
