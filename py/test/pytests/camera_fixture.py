...
class CameraFixture(unittest.TestCase):
  ...
  def setUp(self):
    ...
    # Light panel only supports TestType.LS.
    assert self.fixture_type != Fixture.PANEL or self.test_type == TestType.LS
    assert (self.args.test_chart_version != 'White' or
