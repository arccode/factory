...
def ParseJSONTestList(filename, options):
  ...
  # This is copied from py/test/factory.py, to avoid extra dependency.
  ...
  def RecursiveFindMessages(obj):
    ...
    if isinstance(obj, unicode):
      ...
      # label is automatically generated by pytest_name when not specified.
      if 'label' not in obj and 'pytest_name' in obj:
        messages.append(PytestNameToLabel(obj['pytest_name']))
